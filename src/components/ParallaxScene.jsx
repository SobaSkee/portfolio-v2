...
import Resume from "../assets/Stanley_Ke_Resume_Aug_2025.pdf";
  ...
  return (
    <main ref={sceneRef} className="h-screen w-full" id="home">
      ...
      >
        ...
        <div className="socials w-fit bg-white !p-4 nes-container is-rounded flex flex-col items-center justify-center gap-2">
          ...
          <div className="flex flex-row justify-center gap-2 md:gap-4">
            <a href="https://www.github.com/SobaSkee" target="_blank">
              <i
            ...
            <a href="https://www.linkedin.com/in/stanley-ke/" target="_blank">
              <i
            ...
            <a href="mailto:stanleyke.jobs@gmail.com" target="_blank">
              <i
                className={`nes-icon gmail ${isMediumScreen ? "is-large" : ""}`}
              ></i>
            </a>
          </div>
          <a
      ...
      {isMediumScreen ? (
        ...
        <img
          src={street}
          className={`street-img ${isPaused ? "paused" : ""}`}
          alt="street"
        />
      )}
      ...
      <div className="porsche">
        ...
        <img
          src={porscheWheel}
          className={`porsche-right-wheel ${isPaused ? "paused" : ""}`}
